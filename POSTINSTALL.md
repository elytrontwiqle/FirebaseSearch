...
**"Firestore API has not been used" Error**
- Enable Firestore API in [Google Cloud Console](https://console.developers.google.com/apis/api/firestore.googleapis.com/overview?project=${param:PROJECT_ID})
- Wait a few minutes for the API to be fully enabled

**Permission Denied Errors**
- Check Firestore security rules
- Verify collection names are correct
- Ensure the extension has proper IAM permissions

**No Results Found**
- Verify data exists in the specified fields
- Check field names for typos
- Ensure case sensitivity settings match your data
- Test with a broader search term

**Function Not Found**
- Verify the function URL includes the correct extension instance ID
- Check the deployment region matches your configuration
- Ensure the extension installation completed successfully

### Getting Help

- Review the [complete documentation](https://github.com/your-username/firestore-search-extension)
- Check [usage examples](https://github.com/your-username/firestore-search-extension/tree/main/examples)
- Visit [Firebase Extensions Hub](https://extensions.dev/) for community support
- File issues through Firebase support channels

## Next Steps

1. **Test the Extension**: Try the examples above with your actual data
2. **Update Security Rules**: Configure Firestore rules for your specific use case
3. **Create Indexes**: Set up Firestore indexes for optimal search performance
4. **Integrate into Your App**: Add search functionality to your application
5. **Monitor Performance**: Track usage and optimize based on your needs

## Updating the Extension

To update the extension when new versions are available:
1. Go to Firebase Console > Extensions
2. Find "Firestore Search Extension"
3. Click "Update" when prompted
4. Review and accept any new configuration parameters

## Extension Management

### View Extension Status
```bash
firebase ext:list --project=${param:PROJECT_ID}
```

### Update Extension
```bash
firebase ext:update elytron/firestore-search-extension --project=${param:PROJECT_ID}
```

### Uninstall Extension
```bash
firebase ext:uninstall firestore-search-extension --project=${param:PROJECT_ID}
```
